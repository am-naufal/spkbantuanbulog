                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    @auth
                        ...
                        @if (auth()->user()->role == 'admin')
                            <li class="nav-item">
                                <a class=" btn btn-primary" href="{{ route('adminDashboard') }}">Dashboard</a>
                            </li>
                        @elseif(auth()->user()->role == 'kepala_desa')
                            <li class="nav-item">
                                <a class=" btn btn-primary" href="{{ route('kepalaDesaDashboard') }}">Dashboard</a>
                            </li>
                        @else
                            <li class="nav-item">
                                <a class=" btn btn-primary" href="{{ route('userDashboard') }}">Dashboard</a>
                            </li>
                        @endif
                    @else
                        <li class="nav-item">
                            <a class="btn btn-danger" href="{{ route('login') }}">Masuk</a>
                        </li>
                    @endauth
