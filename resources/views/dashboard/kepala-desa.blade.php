...
@section('judul', 'Dashboard Kepala Desa')
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Total Penilaian</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalPenilaian ?? 0 }}</div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        {{-- <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Penerima Bantuan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
        ...
        {{-- <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                <!-- Card Header -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Distribusi Penerima Bantuan</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
